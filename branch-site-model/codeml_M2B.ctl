seqfile = L4_information.fasta  * sequence data file name
     treefile = L4_information.fasta.treefile * tree structure file name
      outfile =  L4_information_new_M2B.txt    * main result file name
