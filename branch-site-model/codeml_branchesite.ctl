seqfile = L4_information.fasta            * Path to the alignment file
     treefile = L4_information.fasta.treefile          * Path to the tree file
      outfile = L4_information_branchsite.txt            * Path to the output file
   
        noisy = 3              * How much rubbish on the screen
      verbose = 1              * More or less detailed report

      seqtype = 1              * Data type
        ndata = *          * Number of data sets or loci
